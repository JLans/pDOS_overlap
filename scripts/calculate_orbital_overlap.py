...
GAS_DOSCAR = os.path.join(example_path, 'C2H4/DOSCAR')
GAS_CONTCAR = os.path.join(example_path, 'C2H4/CONTCAR')
ADSORBATE_DOSCAR = os.path.join(example_path, 'C2H4+Pt111_pi/DOSCAR')
ADSORBATE_CONTCAR = os.path.join(example_path, 'C2H4+Pt111_pi/CONTCAR')
